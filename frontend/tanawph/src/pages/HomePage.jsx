      ...
      <TopMenu />
        ...
        <div className="w-2xl h-fit flex flex-wrap items-center justify-center">
          ...
          <div className="w-4xl h-fit flex items-center justify-around py-12">
            ...
            <div className="w-1/3 flex flex-col items-center justify-center">
              <img className='size-50 w-auto' src="../src/assets/images/image_hero1.svg"/>
            ...
            <div className="w-1/3 flex flex-col items-center justify-center">
              <img className='size-50 w-auto' src="../src/assets/images/image_hero2.svg"/>
            ...
            <div className="w-1/3 flex flex-col items-center justify-center">
              <img className='size-50 w-auto' src="../src/assets/images/image_hero3.svg"/>
        ...
        <div className="w-2xl grid  gap-y-4">
          <div className="flex w-full text-white bg-[linear-gradient(to_right,#EB5E55,#FFC758)] rounded-full px-8 py-4">
            <img className='h-full 'src="../src/assets/images/image_homeverified1.png" alt="" />
            <div>
          ...
          <div className="flex w-full text-white bg-[linear-gradient(to_right,#EB5E55,#FFC758)] rounded-full px-8 py-4">
            <img className='h-full 'src="../src/assets/images/image_homeverified2.png" alt="" />
            <div>
          ...
          <div className="flex w-full text-white bg-[linear-gradient(to_right,#EB5E55,#FFC758)] rounded-full px-8 py-4">
            <img className='h-full 'src="../src/assets/images/image_homeverified3.png" alt="" />
            <div>
          ...
          <div className="flex w-full text-white bg-[linear-gradient(to_right,#EB5E55,#FFC758)] rounded-full px-8 py-4">
            <img className='h-full 'src="../src/assets/images/image_homeverified4.png" alt="" />
            <div>
          ...
          <div className="flex w-full text-white bg-[linear-gradient(to_right,#EB5E55,#FFC758)] rounded-full px-8 py-4">
            <img className='h-full 'src="../src/assets/images/image_homeverified5.png" alt="" />
            <div>
        ...
        <div className="w-2xl mt-[40vh]">
          ...
          <div className="w-full grid space-y-12">
            ...
            <div className="flex">
              ...
              <img src="../src/assets/images/image_homeoffer1.svg" alt="" />
            </div>
            <div className="flex">
              <img src="../src/assets/images/image_homeoffer2.svg" alt="" />
            ...
            <div className="flex items-center">
              ...
              <img className='h-full' src="../src/assets/images/image_homeoffer3.svg" alt="" />
            </div>
